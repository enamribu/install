...
set -eE
confhome=https://raw.githubusercontent.com/enamribu/install/main
confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/enamribu/install/main
...
test_url_real() {
    ...
    for i in $(seq 5 -1 0); do
        if command wget --no-check-certificate --connect-timeout=10 --header="Range: bytes=0-1048575" -O windows.gz "$url"
